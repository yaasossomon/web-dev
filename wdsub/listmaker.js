...
parentLI .parentElement.style.textDecoration="solid blue0.1em line-though";
  parentLI.parentElement.style.color="black"
  parentLI.innerHTML = CHECKBOX + parentLI.innerText;
}
function uncrossItem(elem){
    let parentLI = elem.parentElement;
  parentLI.parentElement.style.textDecoration="none";
